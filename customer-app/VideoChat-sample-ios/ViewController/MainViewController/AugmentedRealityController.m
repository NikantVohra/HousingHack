...
- (void)updateLocations
{
	...
	for (ARGeoCoordinate *item in [self coordinates]) {
        ...
        MarkerView *markerView = (MarkerView *)[item displayView];
		...
		if ([self shouldDisplayCoordinate:item]) {
            ...
            NSString *message = [NSString stringWithFormat:@"{\"x\":\"%f\",\"y\":\"%f\",\"title\":\"%@\",\"distance\":\"%@\"}",loc.x, loc.y,item.title,markerView.lblDistance.text];            PNChannel *ch = [PNChannel channelWithName:@"Housing"
